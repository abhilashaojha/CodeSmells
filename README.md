...
graph TD;
    ...
    B[Code smell detection and extraction of metrics with iPlasma]-->D(Class Level);
    B[Code smell detection and extraction of metrics with iPlasma]-->E(Method level);
 ```
